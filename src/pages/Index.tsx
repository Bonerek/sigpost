            ...
            <TabsList className="justify-start">
              {tabs.map((tab) => {
                const colorClasses: Record<ColorValue, string> = {
                  blue: "bg-category-blue/70 text-category-blue-foreground data-[state=active]:bg-category-blue data-[state=active]:text-category-blue-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  green: "bg-category-green/70 text-category-green-foreground data-[state=active]:bg-category-green data-[state=active]:text-category-green-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  orange: "bg-category-orange/70 text-category-orange-foreground data-[state=active]:bg-category-orange data-[state=active]:text-category-orange-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  purple: "bg-category-purple/70 text-category-purple-foreground data-[state=active]:bg-category-purple data-[state=active]:text-category-purple-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  red: "bg-category-red/70 text-category-red-foreground data-[state=active]:bg-category-red data-[state=active]:text-category-red-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  cyan: "bg-category-cyan/70 text-category-cyan-foreground data-[state=active]:bg-category-cyan data-[state=active]:text-category-cyan-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  pink: "bg-category-pink/70 text-category-pink-foreground data-[state=active]:bg-category-pink data-[state=active]:text-category-pink-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  yellow: "bg-category-yellow/70 text-category-yellow-foreground data-[state=active]:bg-category-yellow data-[state=active]:text-category-yellow-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  indigo: "bg-category-indigo/70 text-category-indigo-foreground data-[state=active]:bg-category-indigo data-[state=active]:text-category-indigo-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  teal: "bg-category-teal/70 text-category-teal-foreground data-[state=active]:bg-category-teal data-[state=active]:text-category-teal-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  amber: "bg-category-amber/70 text-category-amber-foreground data-[state=active]:bg-category-amber data-[state=active]:text-category-amber-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  lime: "bg-category-lime/70 text-category-lime-foreground data-[state=active]:bg-category-lime data-[state=active]:text-category-lime-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  emerald: "bg-category-emerald/70 text-category-emerald-foreground data-[state=active]:bg-category-emerald data-[state=active]:text-category-emerald-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  brown: "bg-category-brown/70 text-category-brown-foreground data-[state=active]:bg-category-brown data-[state=active]:text-category-brown-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  gray: "bg-category-gray/70 text-category-gray-foreground data-[state=active]:bg-category-gray data-[state=active]:text-category-gray-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  slate: "bg-category-slate/70 text-category-slate-foreground data-[state=active]:bg-category-slate data-[state=active]:text-category-slate-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  zinc: "bg-category-zinc/70 text-category-zinc-foreground data-[state=active]:bg-category-zinc data-[state=active]:text-category-zinc-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  stone: "bg-category-stone/70 text-category-stone-foreground data-[state=active]:bg-category-stone data-[state=active]:text-category-stone-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                  black: "bg-category-black/70 text-category-black-foreground data-[state=active]:bg-category-black data-[state=active]:text-category-black-foreground data-[state=active]:shadow-xl data-[state=active]:scale-105",
                };
